...
function __kubebuilder_prepare_completions
    ...
    set -l results (__kubebuilder_perform_completion)
    __kubebuilder_debug "Completion results: $results"
    ...
    set --global __kubebuilder_comp_results $results[1..-2]
...
complete -c kubebuilder -n '__kubebuilder_prepare_completions' -f -a '$__kubebuilder_comp_results'
